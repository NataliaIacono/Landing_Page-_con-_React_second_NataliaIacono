...
const Navbar = () => {
    return (
        <nav className="navbar navbar-expand-lg p-2 mb-3 btn-primary mb-0">
            <div className="container-fluid">
                <h1 className="titulo" href="#">
                    Turismo <i class="fa-solid fa-plane"></i>
                </h1>
                    ...
                    <span className="navbar-text">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="primerboton nav-link active text-white" target="_blank" aria-current="page" href="https://www.mallorca.es/es/">
                                    La isla
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="segundoboton nav-link text-white" href="https://piensoymascotas.com/1171-comida-gatos">
                                    Playas
                                </a>
                            </li>
                            <li className="nav-item">
                                <a
                                    className="tercerboton nav-link text-white"
